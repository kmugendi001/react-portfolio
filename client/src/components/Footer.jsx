        ...
        >
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            ...
            <motion.div variants={itemVariants} className="space-y-4">
              <h3 className="text-xl font-bold text-gray-900 dark:text-white">PIUS</h3>
              <p className="text-gray-600 dark:text-gray-300 text-sm">
                Security researcher & consultant creating meaningful experiences.
              </p>
          ...
          >
            <div>
              <p>© {currentYear} Pius. All rights reserved.</p>
            </div>
